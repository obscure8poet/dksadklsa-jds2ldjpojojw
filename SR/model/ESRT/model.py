...
from model.ESRT.tools import  reverse_patches
from model.ESRT.transformer import MLABlock

def make_model(upscale=4):
    # inpu = torch.randn(LR, 3, 320, 180).cpu()
...
class one_conv(nn.Module):
    ...
    def forward(self, x):
        ...
        return output  # torch.cat((x,output),LR)
